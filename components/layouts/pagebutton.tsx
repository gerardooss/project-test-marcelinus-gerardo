...
export default function PageButton({ currentPage, totalPage, setCurrentPage }: Props) {
  ...
  return (
    <ReactPaginate
      ...
      nextLabel={<span className="flex bg-zinc-600 text-white items-center justify-center rounded-md w-7 h-8 mx-1 hover:bg-black">&gt;</span>}
      onPageChange={handlePageChange}
      pageRangeDisplayed={5}
      pageCount={totalPage}
      initialPage={currentPage - 1}
      previousLabel={<span className="flex bg-zinc-600 text-white items-center justify-center rounded-md w-7 h-8 mx-1 hover:bg-black">&lt;</span>}
